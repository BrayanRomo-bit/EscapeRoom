...
namespace EscapeRoom
{
    public partial class Nivel1 : NivelBase
    {
        ...
        public override void IniciarNivel()
        {
            ...
            {
                int indiceAleatorio = rndCamas.Next(opciones.Count);
                secuencia.Add(opciones[indiceAleatorio]);
                opciones.RemoveAt(indiceAleatorio);
            }
            ...
            Escondite cama = new Escondite()
            {
                Nombre = nombreCama,
                Imagen = pbCama,
                ObjetoOculto = llavesRestantes[secuencia[0]]
            };
            Escondites.Add(cama);
        ...
        private void pbpuerta1_Click(object sender, EventArgs e)
        {
